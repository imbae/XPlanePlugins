                                   ...
                                   void *               inRefcon)
{
	...
	Aircraft0.plane_x = x + 150.0;
	Aircraft0.plane_y = y;
	Aircraft0.plane_z = z + 150.0;
	Aircraft0.plane_the = 20;
	Aircraft0.plane_phi = phi;
	Aircraft0.plane_psi = psi;

	Aircraft1.plane_x = x + 50.0;
	Aircraft1.plane_y = y;
	Aircraft1.plane_z = z + 50.0;
	Aircraft1.plane_the = theta;
	Aircraft1.plane_phi = phi+count;
	...
	Aircraft2.plane_the = theta + count;
	...
	{
		Aircraft0.plane_gear_deploy[Gear] = GearState;
